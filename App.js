  ...
  return (
    <>
      ...
      <SafeAreaView>
        ...
        { currentScreen === 'messages' ? <ChatRoom Auth={auth} CurrentLocation={currentLocation} updateScreen={updateScreen} RoomCode={roomCode} RoomUsers={roomUsers} Messages={roomMessages} getLocation={getLocation} /> : null }
      </SafeAreaView>
    </>
  );
};
